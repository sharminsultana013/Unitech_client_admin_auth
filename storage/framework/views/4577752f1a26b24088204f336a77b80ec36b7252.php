    ...
    <nav class="navbar navbar-expand-lg fixed-top shadow p-1 mb-5 bg-body" id="navbar">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 10%;">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active menuItem" aria-current="page" href="<?php echo e(route('/')); ?>">Home</a>
            </li>
            <li class="nav-item">
...
</html><?php /**PATH C:\xampp\htdocs\Unitech laravel\resources\views/welcome.blade.php ENDPATH**/ ?>