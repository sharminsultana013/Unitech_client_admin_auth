...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="<?php echo e(route('insert_address')); ?>" method="post" class="form-horizontal" class="dropzone" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($addr->mobile); ?></td>
                                        <td><?php echo e($addr->email); ?></td>
                                        <td>
                                            <button class="btn btn-danger" type="submit"><a href="<?php echo e(url('/addressDelete/')); ?>/<?php echo e($addr->id); ?>" title="delete">
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Unitech laravel\resources\views/admin/address.blade.php ENDPATH**/ ?>