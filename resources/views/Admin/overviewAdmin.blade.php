...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{route('insert_overview')}}" method="post" class="form-horizontal" class="dropzone" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach($overviewlists as $overviewlist)
                                    <tr>
                                        <td>{{$overviewlist->id}}</td>
                                        <td>{{$overviewlist->title}}</td>
